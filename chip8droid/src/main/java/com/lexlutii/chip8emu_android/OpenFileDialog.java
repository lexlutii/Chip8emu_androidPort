...
import static com.lexlutii.chip8emu_android.MainActivity.START_DIR;
...
public class OpenFileDialog extends AlertDialog.Builder {
    ...
    private String currentPath = Environment.getExternalStorageDirectory().getPath()+START_DIR;
